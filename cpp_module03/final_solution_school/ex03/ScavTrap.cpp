...
/*   Updated: 2026/03/05 14:36:12 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string& target) {
  if (_hitPoints == 0) {
    std::cout << MAGENTA << "ScavTrap " << getName()
  ...
  std::cout << YELLOW << "ScavTrap " << getName() << " aggressively strikes "
...
void ScavTrap::guardGate() {
  ...
  std::cout << BLUE << "🛡️ ScavTrap " << getName() << " is now in Gate keeper mode!"
            << RESET << std::endl;
}